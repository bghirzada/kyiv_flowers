                    ...
                    return (
                        index % 2 === 0 ?
                            <>
                                ...
                                <div onClick={() => navigateProduct(cat.id)} className='col-span-1  lg:h-[360px] flex flex-col justify-center items-center relative border-b border-l border-[#121212] cursor-pointer'>
